...
/**
 * Simple test script for Cloudinary upload API using native FormData
 */
...
async function testSimpleUpload() {
  console.log('🧪 Testing Simple Cloudinary Upload API');
  console.log('========================================');
  ...
  // Test 1: Simple image upload using native FormData
  ...
  try {
    ...
    console.log('\n🎉 Test passed!');
    console.log('The Cloudinary upload API is working correctly.');
    console.log('\nKey improvements:');
    console.log('✅ No more DataCloneError - FormData sent directly');
    console.log('✅ No more Content-Type errors');
    console.log('✅ Clean Cloudinary uploads');
