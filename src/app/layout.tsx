            ...
            <LoadingProvider>
              <CartProvider>
                ...
                <div className="bg-black text-white py-2">
                  <MarqueeText text= "Connect to our speed dial cryptocurrency payments method on WhatsApp and get 10% off all products, rush now contact 📞 +2349110108817 +8619879369271 or Email 📧  Trillionairefitstore@gmail.com" />
                </div>
